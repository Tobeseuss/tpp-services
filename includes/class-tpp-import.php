...
class TPP_Import {
        ...
        private function alias_map() {
                return array(
                        ...
                        'f_internet_status'     => array( 'آخرین وضعیت اینترنت', 'وضعیت اینترنت', 'وضعیت اینترنت آخرین' ),
                        'f_phone_status'        => array( 'آخرین وضعیت تلفن', 'وضعیت تلفن' ),
                        'f_modem_model'         => array( 'مدل مودم', 'مودم' ),
                        'f_modem_serial'        => array( 'سریال مودم', 'سریال', 'سريال مودم' ),
                        'f_wifi24_name'         => array( 'نام وای‌فای ۲.۴ گیگاهرتز', 'نام وای فای 2.4', 'نام وایفای 2.4', 'نام وای فای ۲.۴', 'نام وایفای ۲.۴', 'نام وای فای 2.4 گیگاهرتز', 'نام وای فای ۲.۴ گیگاهرتز', 'ssid 2.4', 'ssid2.4', 'wifi 2.4 name', 'نام وای فای', 'ssid', 'wifi name' ),
                        'f_wifi24_pass'         => array( 'رمز وای‌فای ۲.۴ گیگاهرتز', 'رمز وای فای 2.4', 'رمز وایفای 2.4', 'رمز وای فای ۲.۴', 'رمز وایفای ۲.۴', 'رمز وای فای 2.4 گیگاهرتز', 'رمز وای فای ۲.۴ گیگاهرتز', 'پسورد وای فای 2.4', 'پسورد وایفای 2.4', 'wifi 2.4 password', 'wifi 2.4 pass', 'رمز وای فای', 'رمز وایفای', 'wifi password' ),
                        'f_wifi5_name'          => array( 'نام وای‌فای ۵ گیگاهرتز', 'نام وای فای 5', 'نام وایفای 5', 'نام وای فای ۵', 'نام وایفای ۵', 'نام وای فای 5 گیگاهرتز', 'نام وای فای ۵ گیگاهرتز', 'ssid 5', 'ssid5', 'wifi 5 name', 'wifi 5ghz name', 'نام وای فای 5g', 'wifi 5g name' ),
                        'f_wifi5_pass'          => array( 'رمز وای‌فای ۵ گیگاهرتز', 'رمز وای فای 5', 'رمز وایفای 5', 'رمز وای فای ۵', 'رمز وایفای ۵', 'رمز وای فای 5 گیگاهرتز', 'رمز وای فای ۵ گیگاهرتز', 'پسورد وای فای 5', 'پسورد وایفای 5', 'wifi 5 password', 'wifi 5 pass', 'wifi 5ghz password', 'رمز وای فای 5g', 'wifi 5g password' ),
