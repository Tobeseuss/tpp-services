...
const SHELL_ASSETS = [
        ...
        './manifest.json',
        './assets/img/icon.svg',
        './assets/css/app.css?v=1.22.0',
        './assets/js/idb.js?v=1.22.0',
        './assets/js/tpp-offline.js?v=1.22.0',
        './assets/js/tpp-app.js?v=1.22.0',
        './assets/js/tpp-views-form.js?v=1.22.0',
        './assets/js/tpp-views-admin.js?v=1.22.0',
        './assets/js/tpp-views-report.js?v=1.22.0',
        './assets/js/tpp-views-review.js?v=1.22.0',
        './assets/js/tpp-views-api.js?v=1.22.0'
];
