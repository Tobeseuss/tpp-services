 ...
 */
$tpp_this_version = '1.20.0';

if ( ! defined( 'TPP_VERSION' ) ) {

        // باید با $tpp_this_version (بالای فایل) هم‌گام بماند
        define( 'TPP_VERSION', '1.20.0' );
        define( 'TPP_DB_VERSION', '1.20.0' );
